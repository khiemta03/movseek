...
const PaginationCustom = ({ currentPage, totalPage, type, endpoint }: PaginationProps) => {
  return (
    <div>
      {totalPage <= 10 ? (
        <Pagination>
          <PaginationContent>
            <PaginationItem>
              <PaginationPrevious
                ...
                href={`${endpoint}?type=${type}&page=${currentPage - 1}`}
              />
            </PaginationItem>
            {[...Array(totalPage)].map((_, index) => (
              <PaginationItem key={index}>
                <PaginationLink
                  ...
                  href={`${endpoint}?type=${type}&page=${index + 1}`}
                >
                  {index + 1}
                </PaginationLink>
              </PaginationItem>
          ...
          <PaginationContent>
            ...
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=1`}
              >
                1
              </PaginationLink>
            </PaginationItem>
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=2`}
              >
                2
              </PaginationLink>
            </PaginationItem>
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=3`}
              >
                3
              </PaginationLink>
            </PaginationItem>
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=4`}
              >
                4
              </PaginationLink>
            </PaginationItem>
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=5`}
              >
                5
              </PaginationLink>
            </PaginationItem>
            ...
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=${totalPage}`}
              >
                {totalPage}
              </PaginationLink>
            </PaginationItem>
          ...
          <PaginationContent>
            ...
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=${totalPage - 4}`}
              >
                {totalPage - 4}
              </PaginationLink>
            </PaginationItem>
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=${totalPage - 3}`}
              >
                {totalPage - 3}
              </PaginationLink>
            </PaginationItem>
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=${totalPage - 2}`}
              >
                {totalPage - 2}
              </PaginationLink>
            </PaginationItem>
            <PaginationItem>
              <PaginationLink
                ...
                href={`${endpoint}?type=${type}&page=${totalPage - 1}`}
              >
                {totalPage - 1}
              </PaginationLink>
            </PaginationItem>
